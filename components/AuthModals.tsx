    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <p className="text-xs text-gray-500 mt-4">
                Al crear una cuenta, aceptas nuestra <a href="/privacy-policy" target="_blank" rel="noopener noreferrer" className="text-ecuador-blue hover:underline">Política de Privacidad</a> y los <a href="/terms-of-service" target="_blank" rel="noopener noreferrer" className="text-ecuador-blue hover:underline">Términos de Servicio</a>. Tus datos serán utilizados para personalizar tu experiencia y mejorar nuestros servicios.
            </p>
