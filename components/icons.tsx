...
// Tipo genérico para las props de los iconos SVG
type IconProps = React.SVGProps<SVGSVGElement>;

export const BriefcaseIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 14.15v4.075c0 1.313-.964 2.505-2.29 2.75-1.09.19-2.213.34-3.355.45-1.142.11-2.293.165-3.46.165s-2.318-.055-3.46-.165c-1.142-.11-2.265-.26-3.355-.45-1.326-.245-2.29-1.437-2.29-2.75V14.15M16.5 8.25V6a2.25 2.25 0 00-2.25-2.25H9.75A2.25 2.25 0 007.5 6v2.25m9 0H7.5" />
    </svg>
);
